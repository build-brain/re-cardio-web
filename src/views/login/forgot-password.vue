...
export default {
  ...
  validations: {
    email: {
      ...
      email: helpers.withMessage("Пожалуйста введите правильный номер", email),
    },
  },
  data() {
    return {
                ...
                <div class="p-2">
                  ...
                  <form @submit.prevent="tryToReset">
                    <div class="mb-4">
                      ...
                      <input type="number" v-model="email" class="form-control" id="email"
                        :class="{ 'is-invalid': submitted && v$.email.$errors }" placeholder="Введите номер телефона"  />
